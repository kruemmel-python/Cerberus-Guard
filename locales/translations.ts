const en = {
  ...
  settingsApplyNow: 'Apply Settings Now',
  settingsApplyNowPending: 'Applying...',
  settingsAppliedProviderLabel: 'Active backend provider',
  ...
  threatHuntExamplesDescription: 'Click an example to insert it into the input field.',
  threatHuntExample1: 'Show me all blocked IPs from the last 24 hours.',
  threatHuntExample2: 'Show all connections from process opera.exe.',
  threatHuntExample3: 'Which files were rated suspicious or malicious in the sandbox?',
  threatHuntExample4: 'List the last 20 sandbox analyses with file name, verdict and score.',
  threatHuntExample5: 'Show all events with attackType brute_force.',
  threatHuntExample6: 'Which source IPs connected to port 22 or 3389?',
  threatHuntExample7: 'Show suspicious traffic from the last 2 hours.',
  threatHuntExample8: 'Which processes had connections to port 5353?',
  threatHuntExample9: 'Show all traffic entries with decision source llm.',
  threatHuntExample10: 'Which source IPs were blocked more than once?',
  threatHuntExample11: 'List all CAPE or Cerberus Lab analyses that failed.',
  threatHuntExample12: 'Show the highest sandbox scores from today.',
  threatHuntExample13: 'Which files were analyzed from process msedge.exe?',
  threatHuntExample14: 'Show all critical log entries from today.',
  threatHuntExample15: 'Which PCAP artifacts were exported for other or malicious_payload?',
  threatHuntExample16: 'Show suspicious UDP traffic from today.',
  threatHuntExample17: 'Which destination ports were most often blocked?',
  threatHuntExample18: 'Show traffic for sensor Windows Lab Sensor from the last hour.',
  threatHuntExample19: 'Which suspicious events came from decision source cache?',
  threatHuntExample20: 'Show file names, verdicts and timestamps of the latest sandbox analyses.',
...
const de = {
  ...
  threatHuntScopedSensor: 'Die naechste Suche ist auf den Sensor begrenzt: {sensorName}',
  ...
  threatHuntExamplesDescription: 'Ein Klick uebernimmt die Abfrage direkt in das Eingabefeld.',
  threatHuntExample1: 'Zeig mir alle blockierten IPs der letzten 24 Stunden.',
  threatHuntExample2: 'Zeig mir alle Verbindungen vom Prozess opera.exe.',
  threatHuntExample3: 'Welche Dateien wurden in der Sandbox als suspicious oder malicious bewertet?',
  threatHuntExample4: 'Liste die letzten 20 Sandbox-Analysen mit Dateiname, Verdict und Score.',
  threatHuntExample5: 'Zeig mir alle Ereignisse mit attackType brute_force.',
  threatHuntExample6: 'Welche Quell-IPs hatten Verbindungen zu Port 22 oder 3389?',
  threatHuntExample7: 'Zeig mir verdaechtigen Verkehr der letzten 2 Stunden.',
  threatHuntExample8: 'Welche Prozesse hatten Verbindungen zu Port 5353?',
  threatHuntExample9: 'Zeig mir alle Traffic-Eintraege mit decision source llm.',
  threatHuntExample10: 'Welche Quell-IPs wurden mehr als einmal blockiert?',
  threatHuntExample11: 'Liste alle CAPE- oder Cerberus-Lab-Analysen, die fehlgeschlagen sind.',
  threatHuntExample12: 'Zeig mir heute die hoechsten Sandbox-Scores.',
  threatHuntExample13: 'Welche Dateien wurden vom Prozess msedge.exe analysiert?',
  threatHuntExample14: 'Zeig mir alle kritischen Log-Eintraege von heute.',
  threatHuntExample15: 'Welche PCAP-Artefakte wurden fuer other oder malicious_payload exportiert?',
  threatHuntExample16: 'Zeig mir verdaechtigen UDP-Verkehr von heute.',
  threatHuntExample17: 'Welche Ziel-Ports wurden am haeufigsten blockiert?',
  threatHuntExample18: 'Zeig mir Verkehr fuer den Sensor Windows Lab Sensor aus der letzten Stunde.',
  threatHuntExample19: 'Welche verdaechtigen Ereignisse kamen von decision source cache?',
  threatHuntExample20: 'Zeig mir Dateinamen, Verdicts und Zeitstempel der neuesten Sandbox-Analysen.',
  ...
  settingsApplyNow: 'Einstellungen jetzt anwenden',
  settingsApplyNowPending: 'Wird angewendet...',
  settingsAppliedProviderLabel: 'Aktiver Backend-Provider',
  settingsSensorConfig: 'Sensor & Backend',
