const en = {
  ...
  sandboxDescription: 'Recent file submissions from suspicious local processes. Analyses are executed by the backend and persisted for later review.',
  ...
  settingsSandboxDescription: 'Submit suspicious local binaries to a real CAPE sandbox directly from the backend and keep verdicts persisted in the platform.',
  ...
  sandboxEnabledHint: 'Allow the backend to submit suspicious local files to the configured sandbox provider.',
...
const de = {
  ...
  sandboxDescription: 'Letzte Dateieinsendungen verdaechtiger lokaler Prozesse. Die Analysen laufen im Backend und bleiben fuer spaetere Pruefungen gespeichert.',
  ...
  settingsSandbox: 'Sandbox-Integration',
  settingsSandboxDescription: 'Verdaechtige lokale Dateien koennen direkt vom Backend an eine echte CAPE-Sandbox uebergeben und mit Urteil im System gespeichert werden.',
  ...
  sandboxEnabledHint: 'Erlaubt dem Backend, verdaechtige lokale Dateien an den konfigurierten Sandbox-Anbieter zu senden.',
